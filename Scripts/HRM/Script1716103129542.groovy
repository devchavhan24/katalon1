...
WebUI.doubleClick(findTestObject('Object Repository/OrangeHRM/Page_OrangeHRM/p_Username  Admin'))

WebUI.setText(findTestObject('Object Repository/OrangeHRM/Page_OrangeHRM/input_Username_username'), 'Admin')

WebUI.doubleClick(findTestObject('Object Repository/OrangeHRM/Page_OrangeHRM/p_Password  admin123'))
